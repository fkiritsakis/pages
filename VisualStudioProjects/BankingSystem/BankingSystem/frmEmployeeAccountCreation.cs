...
{
    public partial class frmEmployeeAccountCreation : Form
    {
        ...
        public frmEmployeeAccountCreation()
        {
            InitializeComponent();
        }
            ...
            if (txtUsername.Text != String.Empty && txtPassword.Text != String.Empty && txtConfirmPassword.Text != String.Empty && txtFirstName.Text != String.Empty && txtLastName.Text != String.Empty)
            {
                if (txtPassword.Text.Equals(txtConfirmPassword.Text))
                {
                    ...
                    else
                    {
                        ...
                        SqlCommand sqlAccountsCmd = new SqlCommand("INSERT INTO Accounts (Username, Password, isEmploy, isAdmin) VALUES ('" + txtUsername.Text + "','" + txtPassword.Text + "', '1', '0')", sqlCon);
                        SqlCommand sqlAccountDataCmd = new SqlCommand("INSERT INTO AccountData (Username, FirstName, LastName, Balance, isEmployee) VALUES ( '" + txtUsername.Text + "' ,'" + txtFirstName.Text + "','" + txtLastName.Text + "','0', '1')", sqlCon);
